"""
Neelam Redekar edited this script to be compatible with Python/3.7
Source: https://github.com/harvardinformatics/TranscriptomeAssemblyTools/blob/master/FilterUncorrectabledPEfastq.py
Usage: python FilterUncorrectabledPEfastq.py -1 read1.cor.fq -2 read2.cor.fq
...
if __name__=="__main__": 
    ...
    with r1_stream as f1, r2_stream as f2:
        ...
        for entry in R1:
            ...
            head2,seq2,placeholder2,qual2=[j.strip() for j in R2.__next__()]
